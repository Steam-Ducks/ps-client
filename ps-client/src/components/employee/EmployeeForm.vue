  ...
  <form @submit.prevent="submitForm" class="employee-form">
    <div class="image-preview-container">
      ...
      <input
        ...
        class="selector"
      />
      <label for="photo" class="upload-button"> Selecionar Foto </label>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      let errorMessage = '';
      let cpfLimpo = this.employee.cpf.replace(/\D/g, ''); // Remove non-numeric characters
      ...
      try {
        ...
        await EmployeeService.uploadEmployeePhotoToSupabase(
          this.selectedFile,
          uniqueFileName
        );
